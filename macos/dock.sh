...
[ -d "$DOTFILES_DIR" ] && dockutil --no-restart --add "$DOTFILES_DIR" --view grid --display folder --sort name
[ -d "$HOME/Drive" ] && dockutil --no-restart --add "$HOME/Drive" --view grid --display folder --sort name
